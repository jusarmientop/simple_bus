 ...
 *****************************************************************************/
/*****************************************************************************
Regla 1: Si una solicitud está en espera (WAIT) y
        tiene el lock activado (LOCK_SET), se atiende primero.

Regla 2: Si una solicitud ya tiene el lock concedido (LOCK_GRANTED),
        se le da acceso nuevamente.

Regla 3: Si no hay locks, gana la solicitud con la menor prioridad numérica.
